...
python -u ${MERRA2BC}/merra2wrf.py --hourly_interval=3 --do_IC --do_BC --zero_out_first --wrf_dir=${data_dir} --wrf_met_dir=${data_dir}/met_em/ --wrf_met_files=met_em.d01.* >& log.merra2wrf
"""
