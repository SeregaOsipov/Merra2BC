...
def get_merra2wrf_config():
    ...
    config.spc_map = ['ac0 -> 3.56*[SO4];1.e11', 'so4aj -> 1.0*[SO4];1.e9']
    # put all dust into the coarse mode
    config.spc_map += ['corn -> 1.68*[DU001]+1.68*[DU002]+1.68*[DU003]+1.68*[DU004]+1.68*[DU005];1.e7',
    ...
    config.spc_map += ['corn -> 1.98*[SS001]+1.98*[SS002]+1.98*[SS003]+1.98*[SS004]+1.98*[SS005];1.e7',
    ...
    config.spc_map += ['ac0 -> 6.41*[BCPHOBIC]+6.41*[BCPHILIC];1.e11', 'ecj -> 1.0*[BCPHOBIC]+1.0*[BCPHILIC];1.e9']
    # assign OC into primary orgpaj in WRF, similar to the emissions
    config.spc_map += ['ac0 -> 6.41*[OCPHOBIC]+6.41*[OCPHILIC];1.e11', 'orgpaj -> 1.0*[OCPHOBIC]+1.0*[OCPHILIC];1.e9']

    # chem 100: Gases
    config.mera_dir = config.root_path + "/Data/NASA/MERRA2/inst3_3d_chm_Nv/"
    config.mera_files = "MERRA2_400.inst3_3d_chm_Nv.201*"  # "MERRA2_400.inst3_3d_chm_Nv.20170*"
    config.spc_map += ['so2 -> 0.453*[SO2];1.e6', ]
    config.spc_map = ['o3 -> 0.604*[O3];1.e6', 'co -> 1*[CO];1.e6']
